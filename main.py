...
WIDTH = 800
WIN = pygame.display.set_mode((WIDTH, WIDTH)) #setting up the display, WIDTH BY WIDTH = square
pygame.display.set_caption("A* Path Finding Algorithm")

RED = (255, 0, 0)
GREEN = (0, 255, 0)
BLUE = (0, 255, 0)
YELLOW = (255, 255, 0)          #Setting colours for use later
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
PURPLE = (128, 0, 128)
ORANGE = (255, 165, 0)
...
def algorithm(draw, grid, start, end):
    ...
    f_score[start] = f(start.get_pos(), end.get_pos())
    ...
    while not open_set.empty():
        ...
        for neighbours in current.neighbours:
            ...
            if temp_g_score < g_score[neighbours]:
                ...
                f_score[neighbours] = temp_g_score + f(neighbours.get_pos(), end.get_pos())
